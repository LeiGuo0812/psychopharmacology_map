...
本版数据快照日期为 `2026-08-09`。离线载荷含 103 个公开来源目录项；这个数字是来源记录数，不是独立机构数。

## 来源目录构成

| 来源 | 目录项 | 用途 |
|---|---:|---|
| openFDA drug label API | 94 | 药品标签、适应证、不良反应及监管文本 |
| ChEMBL REST API | 1 | 定量亲和力与效价记录 |
| IUPHAR/BPS Guide to PHARMACOLOGY | 4 | 配体、靶点、相互作用及人体组织分布 |
| Open Targets Platform | 1 | 药物—疾病与靶点证据快照 |
| QuickGO | 1 | Gene Ontology 注释 |
| Reactome Content Service | 1 | 经整理的机制通路 |
| 项目术语与编辑范围登记 | 1 | 中文术语和收录范围 |
