...
本版数据快照日期为 `2026-08-12`。离线载荷含 151 个公开来源目录项；这个数字是来源记录数，不是独立机构数。

## 来源目录构成

| 来源 | 目录项 | 用途 |
|---|---:|---|
| openFDA drug label API | 136 | 药品标签、适应证、不良反应及监管文本 |
...
| 监管批准公告与处方资料 | 1 | 地达西尼批准信息与复方产品的证据边界 |
| WHO INN、随机对照试验与编辑范围登记 | 4 | 规范名称、临床试验及扩展药物范围 |
...
知识库不把 `A/B`、`A+B` 或英文 `A and B` 复方产品建立为药物节点。复方产品资料仅在需要说明单一成分路线的证据边界时保留，并明确不能据此拆分各成分的独立临床贡献。
